...
public class DictController extends BaseController {
	...
	public Map<String, Object> dictList(QueryRequest request, Dict dict) {
		PageInfo<Dict> pageInfo = this.dictService.PageList(request,dict);
	/*	PageHelper.startPage(request.getPageNum(), request.getPageSize());
		System.out.println("request.getPageNum()"+request.getPageNum()+", request.getPageSize()"+ request.getPageSize());
		List<Dict> list = this.dictService.findAllDicts(dict,request);
		System.out.println("dict--"+list.toString());
